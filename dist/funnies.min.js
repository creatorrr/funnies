...
function arraySample(a){var e=a.length;return e?a[baseRandom(0,e-1)]:void 0}var baseRandom=require("./_baseRandom");module.exports=arraySample;

},{"./_baseRandom":10}],5:[function(require,module,exports){
function arrayShuffle(r){return shuffleSelf(copyArray(r))}var copyArray=require("./_copyArray"),shuffleSelf=require("./_shuffleSelf");module.exports=arrayShuffle;
...
function baseSample(a){return arraySample(values(a))}var arraySample=require("./_arraySample"),values=require("./values");module.exports=baseSample;

},{"./_arraySample":4,"./values":40}],12:[function(require,module,exports){
function baseShuffle(e){return shuffleSelf(values(e))}var shuffleSelf=require("./_shuffleSelf"),values=require("./values");module.exports=baseShuffle;
...
function shuffleSelf(e,a){var r=-1,f=e.length,n=f-1;for(a=void 0===a?f:a;++r<a;){var o=baseRandom(r,n),l=e[o];e[o]=e[r],e[r]=l}return e.length=a,e}var baseRandom=require("./_baseRandom");module.exports=shuffleSelf;
...
function sample(r){return(isArray(r)?arraySample:baseSample)(r)}var arraySample=require("./_arraySample"),baseSample=require("./_baseSample"),isArray=require("./isArray");module.exports=sample;

},{"./_arraySample":4,"./_baseSample":11,"./isArray":28}],38:[function(require,module,exports){
function shuffle(r){return(isArray(r)?arrayShuffle:baseShuffle)(r)}var arrayShuffle=require("./_arrayShuffle"),baseShuffle=require("./_baseShuffle"),isArray=require("./isArray");module.exports=shuffle;
...
function values(e){return null==e?[]:baseValues(e,keys(e))}var baseValues=require("./_baseValues"),keys=require("./keys");module.exports=values;
...
"use strict";function _interopRequireDefault(e){return e&&e.__esModule?e:{default:e}}function _classCallCheck(e,s){if(!(e instanceof s))throw new TypeError("Cannot call a class as a function")}Object.defineProperty(exports,"__esModule",{value:!0}),exports.Funnies=exports.default=void 0;var _createClass=function(){function e(e,s){for(var n=0;n<s.length;n++){var r=s[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}return function(s,n,r){return n&&e(s.prototype,n),r&&e(s,r),s}}(),_funnies=require("./funnies"),_funnies2=_interopRequireDefault(_funnies),_shuffle=require("lodash/shuffle"),_shuffle2=_interopRequireDefault(_shuffle),_sample=require("lodash/sample"),_sample2=_interopRequireDefault(_sample),Funnies=function(){function e(){var s=this,n=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};_classCallCheck(this,e),r.appendMessages=void 0===r.appendMessages||r.appendMessages,r.appendMessages?this.messages=(0,_shuffle2.default)(_funnies2.default.concat(n)):this.messages=(0,_shuffle2.default)(n),this.record={},this.messages.forEach(function(e){s.record[e]=0})}return _createClass(e,[{key:"message",value:function(){var e=this,s=this.messages.reduce(function(s,n){return e.record[s]>e.record[n]?n:e.record[s]===e.record[n]?(0,_sample2.default)([s,n]):s});return this.record[s]+=1,s}},{key:"messageHTML",value:function(){var e=this.message();return{message:e,html:('\n      <div class="funnies">\n        <span class="loading-funny">'+e+"</span>\n      </div>\n    ").replace(/(\r?\n|^ +)/gm,"")}}}]),e}();exports.default=Funnies,exports.Funnies=Funnies,"undefined"!=typeof window&&(window.Funnies=Funnies);
